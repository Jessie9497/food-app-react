...
const Navbar = () => {
  ...
  return (
    ...
    items-center p-4'>
      ...
      Fast <span className='font-bold'>Eats</span>
      </h1>
    ...
    {/* Side drawer menu */}
    <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300':'fixed top-0 left-[-100%] w-[300px] h-screen bg-whitez-10 duration-300'}>
      <AiOutlineClose
      onClick={()=> setNav(!nav)}
       size={30} className='absolute right-4 top-4 cursor-pointer' />
      <h2 className='text-2xl p-4'>Fast <span className='font-bold'>Eats</span></h2>
      <nav>
